...
const PROJECTS = [
  'Commercial Apiary Setup & Management',
  'Smart Hive & AgTech Advisory',
  'Cooperative & Community Training',
  'Wholesale Bee Products Supply (Honey, Beeswax, Propolis)',
  'General Apiculture Consultation',
];
...
export default function ConsultationForm() {
  ...
  return <motion.form onSubmit={submit} initial={{ opacity: 0, y: 28 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, amount: 0.18 }} transition={{ duration: 0.6, ease: [0.16, 1, 0.3, 1] }} className="rounded-[1.75rem] border border-emerald-900/10 bg-white p-6 shadow-[0_22px_50px_-30px_rgba(6,78,59,0.45)] sm:p-8">
