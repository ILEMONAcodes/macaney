          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16 items-center relative z-10">
            ...
            <div className="lg:col-span-6 flex flex-col items-center lg:items-start text-center lg:text-left space-y-6">
              ...
              <h1 className="font-serif text-3xl sm:text-4xl lg:text-5xl font-bold tracking-tight text-stone-900 leading-[1.1]">
                10 Signs You May Not Be Eating Real Honey <span className="text-green-800 block sm:inline">An Essential Guide to Apicultural Authenticity</span>
              </h1>

              {/* Large, dominant ebook mockup — scales with column width on desktop */}
              <div className="relative w-full max-w-[400px] sm:max-w-[480px] lg:max-w-none lg:w-[85%] aspect-[4/5] mx-auto lg:mx-0 transform transition-all duration-500 drop-shadow-[0_30px_40px_rgba(0,0,0,0.25)]">
                <Image
